...
* FedPara: Low-rank Hadamard Product for Communication-Efficient Federated Learning[[ICLR]](https://openreview.net/pdf?id=d71n4ftoCBy)
...
* Diurnal or Nocturnal? Federated Learning of Multi-branch Networks from Periodically Shifting Distributions[[ICLR]](https://openreview.net/pdf?id=E4EE_ohFGz) 
* FedBABU: Towards Enhanced Representation for Federated Image Classification[[ICLR]](https://arxiv.org/pdf/2106.06042.pdf)  
...
* Personalized Federated Learning with Theoretical Guarantees: A Model-Agnostic Meta-Learning Approach[NeurIPS][[Per-FedAvg]](https://papers.nips.cc/paper/2020/file/24389bfe4fe2eba8bf9aa9203a44cdad-Paper.pdf)  
